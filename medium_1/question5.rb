...
# undefined local variable or method 'limit' (NameError)

# limit is not available to the method as it was not passed in as
# an argument and is not one of the method's parameters.

limit = 15

def fib(first_num, second_num, max)
