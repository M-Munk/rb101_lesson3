...
def fun_with_ids
  ...
  # the below aren't defined and will print the rescue text
...
def an_illustrative_method(a_outer, b_outer, c_outer, d_outer, a_outer_id, b_outer_id, c_outer_id, d_outer_id)
  ...
  # reassignment inside method will change object_id inside method
  a_outer = 22
  ...
  # will be same as reassigned ids
  a_inner = a_outer
  b_inner = b_outer
  c_inner = c_outer
  d_inner = c_inner[0]
